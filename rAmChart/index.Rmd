...
The package rAmChart allows you to draw JavaScript charts wich are by nature interactive.
...
* Other complex first level properties, like`dataProvider`, have their own dedicated function. For these, the first argument is always an S4 class object **AmChart** (or **AmStock**).
